...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AIzaSyAP5BQz_BVsixSBU5g8UgggcEbQnXj8yIM";
    private static final String CONTENT_TYPE = "Content-Type";
    private static final String APPLICATION_JSON = "application/json";
    private static final String AUTHORIZATION = "Authorization";
    private static final String AUTH_KEY = "key=" + SERVER_API_KEY;
    private static final String FCM_URL = "https://forumappchat.firebaseio.com";
    // json related keys
